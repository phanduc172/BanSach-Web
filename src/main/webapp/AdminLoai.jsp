...
<body>
	...
	<div class="container">
	<form action="AdminLoaiController" method="post" class="form-inline d-flex justify-content-between align-items-center">
	    <div class="form-group">
	    ...
	    <div class="form-group">
	        ...
	        <input name="txttenloai" type="text" class="form-control">
	    </div>
	    <div class="form-group">
	        <input class="btn btn-primary" name="butadd" type="submit" value="Thêm">
	    </div>
	    <div class="form-group">
	        <input class="btn btn-primary" name="butupdate" type="submit" value="Cập nhật">
	    </div>
	</form>
	</div>
	<br>
	<h4 align="center"><b>DANH SÁCH CÁC LOẠI</b></h4>
	<div class="container">
		...
		<c:forEach var="loai" items="${dsloai}" >
			<tr>
				...
				<td> <a href="AdminLoaiController?ml=${loai.getMaloai()}&tab=chon">Chọn</a> </td>
